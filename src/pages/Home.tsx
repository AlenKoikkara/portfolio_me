...
const Home: React.FC = () => {
  return (
    <WebLayout>
      <div className="flex py-[30px] flex-col justify-center items-start gap-[25px] text-4xl h-full w-full font-bold bg-image bg-blackboard-black dark:bg-white">
        <div className="w-full flex flex-col justify-center items-start gap-[16px] text-white dark:text-blackboard-black text-[clamp(2rem,6vw,7rem)] font-[300] transition-all duration-300 relative">
